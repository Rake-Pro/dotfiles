...
```
curl -fsSL https://dotfiles.rake.pro/install | bash
```
...
```
curl -fsSL https://dotfiles.rake.pro/nuke | bash      # prompts, then cleans
curl -fsSL https://dotfiles.rake.pro/nuke | bash -s -- -n   # dry-run, changes nothing
```
