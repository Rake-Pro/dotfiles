# kubectl aliases. Loaded only when ~/.config/zsh/.is_k8s marker exists.
# zsh-native completion (no third-party complete-alias):
...
alias kecrd="kubectl edit customresourcedefinitions"
...
alias kdelcrd="kubectl delete customresourcedefinitions"
...
alias kpchcrd="kubectl patch customresourcedefinitions"
...
alias krdebug="kubectl run debug --image=ubuntu:noble --restart=Never --rm --stdin --tty -- bash"
